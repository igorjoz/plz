...
int main()
{
    ...
    if (input.good()) {
        ...
        sequencesQuantity++;
        sequence* s = new sequence[sequencesQuantity]; // s[0] to glowny ciag, ID to 0;
        ...
        for (int i = 1; i < sequencesQuantity; i++) { // i = 1, bo nie sprawdzam pierwszego ci¹gu
            int maxSubStrSize = 0;
        ...
        for (int i = 0; i < sequencesQuantity; i++) {
            ...
            if (s[i].ascPrimesStreak == s[0].ascPrimesStreak) {
        ...
        * przy równych n podobieñstwo jest nierozró¿nialne
        3. ci¹g niemalej¹cy
        4. numer porz¹dkowy
        */
